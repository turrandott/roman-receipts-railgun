...
function Home() {
  ...
  return (
    <div className="bg-white text-black">
      ...
      <main>
              ...
              <div className="w-full px-4 lg:w-7/12">
                <div className="wow fadeInUp mb-12 lg:mb-0 lg:max-w-[570px]" data-wow-delay=".2s">
                  ...
                  <h1 className="mb-6 text-3xl font-bold leading-tight text-black  sm:text-[40px] md:text-[50px] lg:text-[42px] xl:text-[50px]">
                    Using
                    <span className="inline bg-secondary bg-clip-text text-transparent mx-2">TalentLayer & XMTP</span>
                    protocols.
                  </h1>
          ...
          <div className="container">
            <div className="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center lg:mb-[70px]" data-wow-delay=".2s">
              ...
              <p className="text-base text-body">
                With value-added features and a user-friendly environment, our starter kit empowers you to unlock the
                full potential of TalentLayer and XMTP, enabling the creation of an outstanding dapp experience
              </p>
            </div>
          </div>
		...
		s-57.082-4.852-83.768-16.791c-0.477-0.323-2.265-1.932-2.36-8.238C157.58,307.036,159.677,266.771,172.086,248.342z
		 M285.438,433.861H150.569v-21.553h134.868V433.861L285.438,433.861z M336.882,391.455H150.569v-21.553h186.312V391.455z"
                    ...
                    <h3 className="mb-4 text-xl font-semibold text-black  sm:text-[22px] xl:text-[26px]">Identity</h3>
                    <p className="text-base text-body">
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  <div className="wow fadeInUp group mx-auto mb-[60px] max-w-[310px] text-center" data-wow-delay=".3s">
                    ...
                    <p className="text-base text-body">Enable direct and secure messaging between wallets using XMTP</p>
                  </div>
                </div>
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  <div className="wow fadeInUp group mx-auto mb-[60px] max-w-[310px] text-center" data-wow-delay=".3s">
                    ...
                    <h3 className="mb-4 text-xl font-semibold text-black  sm:text-[22px] xl:text-[26px]">Reputation</h3>
                    <p className="text-base text-body">
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3 relative">
                  <div className="wow fadeInUp group mx-auto mb-[60px] max-w-[310px] text-center" data-wow-delay=".4s">
                    ...
                    {/* <div className='absolute top-[-5px] right-[40px] md:right-[100px] p-2 bg-secondary text-white text-xs rounded-md'>
                      Coming Soon
                    </div> */}
                    <p className="text-base text-body">
              ...
              <div className="-mx-4 flex flex-wrap items-center justify-between">
                <div className="w-full px-4 lg:w-1/2">
                  <div
                    ...
                    data-wow-delay=".2s"
                  >
                    <img src="/images/home/about/about-1-light.png" alt="about image" className="mx-auto max-w-full" />
                    ...
                    <div className="absolute bottom-0 left-0 -z-10 h-1/2 w-full rounded-[20px] bg-secondary">
                ...
                <div className="w-full px-4 lg:w-1/2">
                  <div className="wow fadeInUp lg:ml-auto lg:max-w-[510px]" data-wow-delay=".3s">
                    ...
                    <p className="mb-[30px] text-base leading-relaxed text-body">
                      This project aims to help builders and hackers to start fast on using XMTP and TalentLayer
                      protocols. It contains demo code for all the previous features.
                      <br />
                    ...
                    <div className="mb-[30px] flex items-center">
                      ...
                      <div>
                        <h5 className="text-xl font-medium text-black ">In-Chat Bounty Management</h5>
                        <p className="text-base text-body">
                          a messaging app with native features to manage hiring and paying bounties. Imagine if you
                          could submit your hackathon project, get it approved for a bounty, and receive payment, all
                          with a few DMs, without leaving your messaging app.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-base text-body">
                          Imagine an app tailored for freelancers, enabling effortless communication with clients,
                          seamless agreement on gigs, and secure payments all through simple messaging.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="-mx-4 flex flex-wrap justify-center">
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  <div className="wow fadeInUp group mx-auto mb-[60px] max-w-[310px] text-center" data-wow-delay=".2s">
                    ...
                    <p className="text-base text-body">
                      ...
                      <a className="underline" target="_blank" href="https://docs.talentlayer.org/get-a-platform-id">
                        it's here
                      </a>
                    </p>
                  </div>
                ...
                <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                  <div className="wow fadeInUp group mx-auto mb-[60px] max-w-[310px] text-center" data-wow-delay=".3s">
                    ...
                    <h3 className="mb-4 text-xl font-semibold text-black  sm:text-[22px] xl:text-[26px]">Setup</h3>
                    <p className="text-base text-body">
        ...
        <section id="testimonials" className="relative z-10 pt-[110px] pb-[60px]">
          <div className="container">
            <div className="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center lg:mb-[70px]" data-wow-delay=".2s">
              ...
              <p className="text-base text-body">
                We highly value feedback from our users as it plays a crucial role in enhancing our starter kit,
                refining the user experience, and continuously improving the features and functionality to meet the
            ...
            <div className="-mx-6 flex flex-wrap">
                ...
                >
                  <div className="mb-5 border-b border-stroke">
                    <p className="pb-9 text-base text-body">
                      The integration process of the TalentLayer and XMTP protocols was seamless using your starter kit.
                      It saved us a significant amount of time and effort, allowing us to focus more on building unique
                      features for our dapp. The documentation provided was clear and comprehensive, making it easy for
                      our development team to understand and utilize the kit effectively.
                    </p>
                  </div>
              ...
              <div className="w-full px-6 lg:w-1/2">
                ...
                >
                  <div className="mb-5 border-b border-stroke">
                    <p className="pb-9 text-base text-body">
                      We appreciate the value-added features included in your starter kit. The pre-built components and
                      streamlined development environment made it simple to create a great dapp experience quickly.
                      Additionally, the responsiveness of your support team in addressing our queries and providing
                      guidance was outstanding. <br />
                      Thank you :)
                    </p>
                  </div>
        ...
        <section id="faq" className="relative z-10 bg-[#F8FAFB] py-[110px] ">
          <div className="container">
            <div className="wow fadeInUp mx-auto mb-14 max-w-[690px] text-center lg:mb-[70px]" data-wow-delay=".2s">
              ...
              <p className="text-base text-body">
                Find answers to commonly asked questions about our Next.js starter kit for TalentLayer and XMTP
                integration, helping you navigate through the implementation process and make the most out of the
                powerful features provided.
              </p>
            </div>
            ...
            >
              ...
              <div className="faq border-b border-stroke last-of-type:border-none">
                ...
                <div className="pb-4 h-auto overflow-hidden px-[18px] sm:px-[26px]">
                  <p className="text-base text-body">
                    No, you do not need an admin account to use XMTP. The XMTP protocol is designed to be plug and play,
                    allowing users to seamlessly integrate and utilize its functionality without the need for an admin
                    account.
                  </p>
                </div>
              </div>
              ...
              <div className="faq border-b border-stroke last-of-type:border-none">
                ...
                <div className="pb-4 h-auto overflow-hidden px-[18px] sm:px-[26px]">
                  <p className="text-base text-body">
                    Yes, TalentLayer the minimum viable for interoperability. You can add any other fields in the IPFS
                    json linked to a review. This is also the case for user profile and service data.
                  </p>
                </div>
              </div>
              ...
              <div className="faq border-b border-stroke last-of-type:border-none">
                ...
                <div className="pb-4 h-auto overflow-hidden px-[18px] sm:px-[26px]">
                  <p className="text-base text-body">
                    Yes it's better to mint your platformId, it will let you configure your platform, define fees and
      ...
      <footer>
        <div className="wow fadeInUp bg-secondary py-7" data-wow-delay=".2s">
          <div className="container max-w-[1390px]">
            <div className="-mx-3 flex flex-wrap">
              <div className="order-last w-full px-3 lg:order-first lg:w-1/3">
                <p className="mt-4 text-center text-base text-white lg:mt-0 lg:text-left">&copy; 2023 StartKit</p>
              </div>
